    ...
    <>
      <div className="hidden lg:block flex-1 max-w-[350px] text-[15px]">
        <div className="hidden lg:block">
          <div className=" bg-white dark:bg-dark px-3 pb-3 py-1">
            <input
              type="text"
              className="w-full p-3 mt-1 rounded-3xl bg-gray-100 dark:bg-dark-lighter placeholder:text-sm placeholder:p-2 outline-none active:bg-white focus:bg-white duration-100 focus:outline-2 focus:outline-green-500 px-5"
              placeholder="Search"
            />
          </div>
          {/* <div className="pt-[62px]"></div> */}
          <div className="w-full px-3 pb-3 py-1">
            <div className="px-3 w-full bg-gray-50 dark:bg-dark-light rounded-3xl mt-2">
